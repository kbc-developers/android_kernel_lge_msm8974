			       ...
			       struct mdss_panel_common_pdata *panel_data)
{
	...
	pr_info("%s: LGD_CHANGE -> v_pw=%d, v_bp=%d, v_fp=%d\n", __func__,
				panel_data->panel_info.lcdc.v_pulse_width, panel_data->panel_info.lcdc.v_back_porch, panel_data->panel_info.lcdc.v_front_porch);
